...
class TestStorage:
    ...
    def test_store_and_retrieve_prompt(self):
        ...
        prompt = Prompt(id=generate_id(), title="Test Title", content="Test Content", description="Test Description", created_at=get_current_time(), updated_at=get_current_time())
    ...
    def test_update_prompt(self):
        ...
        prompt = Prompt(id=generate_id(), title="Title Before", content="Content Before", description="Description Before", created_at=get_current_time(), updated_at=get_current_time())
    ...
    def test_delete_prompt(self):
        ...
        prompt = Prompt(id=generate_id(), title="ToDelete", content="Content", description="Description", created_at=get_current_time(), updated_at=get_current_time())
    ...
    def test_store_and_retrieve_collection(self):
        ...
        collection = Collection(id=generate_id(), name="Test Collection", description="Test Description", created_at=get_current_time())
    ...
    def test_delete_collection(self):
        ...
        collection = Collection(id=generate_id(), name="ToDelete", description="Description", created_at=get_current_time())
