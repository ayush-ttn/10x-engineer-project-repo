...
class TestUtils:
    ...
    def test_sort_prompts_by_date(self):
        ...
        prompt1 = Prompt(id="1", title="First", content="Content 1", description="Desc 1", collection_id=None, created_at=get_current_time(), updated_at=get_current_time())
        time.sleep(0.1)  # Ensure a difference in time
        prompt2 = Prompt(id="2", title="Second", content="Content 2", description="Desc 2", collection_id=None, created_at=get_current_time(), updated_at=get_current_time())
